...
%NUMDIMS   Modifies the default behaviour of the ndims function for empty arrays and row-like arrays, allowing to return a number of dimensions lower than 2
%   ND=NUMDIMS(X)
%   * X is an array
